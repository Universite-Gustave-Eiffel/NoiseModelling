...
import org.orbisgis.noisemap.core.jdbc.PointNoiseMap_Cnossos_Att;
 ...
 */
public class CNOSSOS_Att extends AbstractFunction implements ScalarFunction {
    ...
    public static ResultSet noisePropagation(Connection connection, String buildings, String buildings_height_field,
        ...
        if(TableUtilities.isColumnListConnection(connection)) {
            ...
            PointNoiseMap_Cnossos_Att noiseMap = new PointNoiseMap_Cnossos_Att(TableLocation.capsIdentifier(buildings, true),
    ...
    private static class PointRowSource implements SimpleRowSource {
        ...
        private int cellI = -1;
        private int cellJ = 0;
        private PointNoiseMap_Cnossos_Att noiseMap;
        private Connection connection;

        private PointRowSource(PointNoiseMap_Cnossos_Att noiseMap, Connection connection) {
        ...
        public Object[] readRow() throws SQLException {
            ...
            row[1] = record.getSourceRecordRow();
