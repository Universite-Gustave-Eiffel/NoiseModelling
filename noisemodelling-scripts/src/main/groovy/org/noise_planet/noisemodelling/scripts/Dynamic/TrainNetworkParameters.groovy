...
def exec(Connection connection, Map input) {
    ...
    def trackTrans = "SNCF1"
    if(input["trackTrans"]) {
        trackTrans = input["trackTrans"] as String
    }
    def railRoughn = "SNCF1"
    if(input["railRoughn"]) {
        railRoughn = input["railRoughn"] as String
    }

    def impactNois = "SNCF0"
    if(input["impactNois"]) {
        impactNois = input["impactNois"] as String
    }
    ...
    def bridgeTran = "SNCF0"
    if(input["bridgeTran"]) {
        bridgeTran = input["bridgeTran"] as String
    }
