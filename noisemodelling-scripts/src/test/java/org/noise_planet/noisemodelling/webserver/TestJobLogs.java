...
public class TestJobLogs {
    ...
    public void testFilterExceptionOtherJob() throws IOException, URISyntaxException {
        ...
        assertEquals("[JOB_9][JOB_9] INFO  15 déc. 16:23:25 - End : Display database" + System.lineSeparator() + "[JOB_9][JOB_9] INFO  15 déc. 16:23:25 - " +
                ...
                ".Configuration@30cb6bcc, showColumns=true}"  + System.lineSeparator() + "[JOB_9][JOB_9] INFO  15 déc. 16:23:25 - Start : Display " +
                "database" + System.lineSeparator(), lastLines);
    }
