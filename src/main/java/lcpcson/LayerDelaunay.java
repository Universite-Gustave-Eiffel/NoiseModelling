...
public interface LayerDelaunay {
	 ...
	 */
	void hintInit(Envelope boundingBox,long polygonCount,long verticesCount)  throws LayerDelaunayError ;
	/**
	 ...
	 */
	ArrayList<Coordinate> getVertices()  throws LayerDelaunayError;
	/**
	 * When the processDelaunay has been called, retrieve results
	 * Triangle link unique vertices by their index.
	 */
	ArrayList<Triangle> getTriangles()  throws LayerDelaunayError;
	/*
