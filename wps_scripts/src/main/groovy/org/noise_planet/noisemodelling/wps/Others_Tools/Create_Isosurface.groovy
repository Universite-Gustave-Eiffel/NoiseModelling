...
inputs = [resultTable  : [name: 'Noise levels table', title: 'Name of the noise table', description: 'Name of the noise table, ex LDEN_GEOM or LDAY_GEOM or LEVENING_GEOM or LNIGHT_GEOM generated from LDEN_FROM_ROAD_EMISSION. Receivers table must be created using Delaunay_Grid function',
                      type: String.class],
          outputTable: [name: 'Contouring noise map table', title: 'Name of the output table. Default is <b>CONTOURING_NOISE_MAP</b>', description: 'Name of the created table, will be deleted if it exists.',
                        min: 0, max: 1, type: String.class],
          triangleTable: [name: 'Triangle vertices table', title: 'Triangle table', description: 'This table is generated by Delaunay_Grid function.',
                        min: 0, max: 1, type: String.class],
          isoClass: [name: 'Iso-levels', title: 'Iso levels in dB', description: 'Comma separated noise level (dB) separation of surfaces. Default to 35.0,40.0,45.0,50.0,55.0,60.0,65.0,70.0,75.0,80.0,200.0',
                          min: 0, max: 1, type: String.class],
          smoothCoefficient: [name: 'Polygon smoothing coefficient', title: 'Bezier curve coefficient', description: 'This coefficient will smooth generated isosurfaces. At 0 it disables the smoothing step.',
...
def exec(Connection connection, input) {
    ...
    System.out.println(String.format(Locale.ROOT, 'Duration : %ld ms', System.currentTimeMillis() - start));
