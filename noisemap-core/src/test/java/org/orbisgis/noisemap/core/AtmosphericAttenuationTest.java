...
public class AtmosphericAttenuationTest {
    ...
    public void atmoTestMinus20degree() {
        ...
        for(int idfreq=0;idfreq< expected.length;idfreq++) {
            int freq = freqLvl.get(idfreq);
            double coefAttAtmos = PropagationProcessData.getCoefAttAtmos(freq, humidity,pressure,temperature+PropagationProcessData.K_0);
            assertEquals(expected[idfreq], coefAttAtmos, 0.15);
        }
    }
    ...
    public void atmoTestMinus15degree() {
        ...
        for(int idfreq=0;idfreq< expected.length;idfreq++) {
            int freq = freqLvl.get(idfreq);
            double coefAttAtmos = PropagationProcessData.getCoefAttAtmos(freq, humidity,pressure,temperature+PropagationProcessData.K_0);
            assertEquals(expected[idfreq], coefAttAtmos, 0.2);
        }
    }
    ...
    public void atmoTest0degree() {
        ...
        for(int idfreq=0;idfreq< expected.length;idfreq++) {
            int freq = freqLvl.get(idfreq);
            double coefAttAtmos = PropagationProcessData.getCoefAttAtmos(freq, humidity,pressure,temperature+PropagationProcessData.K_0);
            assertEquals(expected[idfreq], coefAttAtmos, 1.3);
        }
    }
    ...
    public void atmoTest20degree() {
        ...
        for(int idfreq=0;idfreq< expected.length;idfreq++) {
            int freq = freqLvl.get(idfreq);
            double coefAttAtmos = PropagationProcessData.getCoefAttAtmos(freq, humidity,pressure,temperature+PropagationProcessData.K_0);
            assertEquals(expected[idfreq], coefAttAtmos, 0.92);
        }
    }
}
