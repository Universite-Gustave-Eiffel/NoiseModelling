...
public class PathFinderTest {
    ...
    public void TC25(){
        ...
        try {
            exportScene("target/T25.kml", builder, propDataOut);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public void TC26(){
        ...
        computeRays.run(propDataOut);
        try {
            exportScene("target/T26.kml", builder, propDataOut);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        // No datas cnossos for test
    ...
    public void TestMagui(){
        ...
        computeRays.run(propDataOut);
        try {
            exportScene("target/TestM.kml", builder, propDataOut);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
