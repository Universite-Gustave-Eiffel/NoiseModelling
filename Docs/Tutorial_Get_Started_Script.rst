...
Below is an example of a sequence of simple .groovy scripts, using bash instructions and launching the steps described in the ":doc:`Tutorial_Get_Started_GUI`".
