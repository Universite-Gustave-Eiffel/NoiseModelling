...
public class PointSource {
    ...
    private double[] lW ; // spectrum of the point source in dB
    ...
    public PointSource(double[] lW, double sourceHeight, String typeSource, String directivity) {
        this.lW = lW;
        this.sourceHeight = sourceHeight;
        this.typeSource = typeSource;
        this.directivity = directivity;
    ...
    public PointSource(double[] lW, double sourceHeight, String typeSource) {
        this.lW = lW;
        this.sourceHeight = sourceHeight;
        this.typeSource = typeSource;
    }

    public PointSource(String typeSource) {
        this.typeSource = typeSource;
    }
