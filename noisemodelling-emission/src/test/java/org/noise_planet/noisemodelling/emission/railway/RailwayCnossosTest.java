...
public class RailwayCnossosTest {
    ...
    public void Test_Cnossos_Rail_emission_section_1() throws IOException {
        ...
        for (int idFreq = 0; idFreq < 24; idFreq++) {
            assertEquals(expectedValuesLWRolling[idFreq], lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq], EPSILON_TEST1);
            assertEquals(expectedValuesLWTractionA[idFreq], lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq], EPSILON_TEST1);
            assertEquals(expectedValuesLWTractionB[idFreq], lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq], EPSILON_TEST1);
            assertEquals(expectedValuesLWAerodynamicA[idFreq], lWRailWay.getRailwaySourceList().get("AERODYNAMICA").getlW()[idFreq], EPSILON_TEST1);
            assertEquals(expectedValuesLWAerodynamicB[idFreq], lWRailWay.getRailwaySourceList().get("AERODYNAMICB").getlW()[idFreq], EPSILON_TEST1);
            assertEquals(expectedValuesLWBridge[idFreq], lWRailWay.getRailwaySourceList().get("BRIDGE").getlW()[idFreq], EPSILON_TEST1);
        }
    }
    ...
    public void Test_Cnossos_Rail_emission_section_4() throws IOException {
        ...
        RailWayParameters lWRailWay = null;
    ...
    public void Test_Cnossos_Rail_emission_OC1() throws IOException {
        ...
        for (int idFreq = 0; idFreq < 24; idFreq++) {
            ...
            //Day
            double rolling = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            double tractionA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            double tractionB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            ...
            //Evening
            rolling = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            tractionA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            tractionB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            ...
            //Night
            rolling = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
            tractionA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
            tractionB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
    ...
    public void Test_Cnossos_Rail_emission_OC3() throws IOException {
        ...
        for (int idFreq = 0; idFreq < 24; idFreq++) {
            ...
            //Day
           double r = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            double tA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            double tB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            double aA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("AERODYNAMICA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            double aB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("AERODYNAMICB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTDay) / 10));
            ...
            //Evening
            r = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            tA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            tB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            aA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("AERODYNAMICA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            aB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("AERODYNAMICB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTEvening) / 10));
            ...
            //Night
            r = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
            tA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
            tB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
            aA = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("AERODYNAMICA").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
            aB = 10 * Math.log10(Math.pow(10, (lWRailWay.getRailwaySourceList().get("AERODYNAMICB").getlW()[idFreq] + 10 * Math.log10(nBUnit) + deltaTNight) / 10));
    ...
    public void Test_Cnossos_Rail_emission_OC5() throws IOException {
        ...
        // Compute
        RailwayVehicleCnossosParameters vehicleParameters1 = new RailwayVehicleCnossosParameters(vehCat1, vehicleSpeed1, vehiclePerHour1, rollingCondition1, idlingTime1);
        RailwayVehicleCnossosParameters vehicleParameters2 = new RailwayVehicleCnossosParameters(vehCat2, vehicleSpeed2, vehiclePerHour2, rollingCondition2, idlingTime2);
        RailwayVehicleCnossosParameters vehicleParameters3 = new RailwayVehicleCnossosParameters(vehCat3, vehicleSpeed3, vehiclePerHour3, rollingCondition3, idlingTime3);
        RailwayVehicleCnossosParameters vehicleParameters4 = new RailwayVehicleCnossosParameters(vehCat4, vehicleSpeed4, vehiclePerHour4, rollingCondition4, idlingTime4);
        RailwayVehicleCnossosParameters vehicleParameters5 = new RailwayVehicleCnossosParameters(vehCat5, vehicleSpeed5, vehiclePerHour5, rollingCondition5, idlingTime5);
        RailwayTrackCnossosParameters trackParameters = new RailwayTrackCnossosParameters(vMaxInfra, trackTransfer, railRoughness,
                impactNoise, bridgeTransfert, curvature, vehicleCommercial, isTunnel, nTracks);
        RailWayParameters lWRailWay1 = railwayCnossos.evaluate(vehicleParameters1, trackParameters);
        RailWayParameters lWRailWay2 = railwayCnossos.evaluate(vehicleParameters2, trackParameters);
        RailWayParameters lWRailWay3 = railwayCnossos.evaluate(vehicleParameters3, trackParameters);
        RailWayParameters lWRailWay4 = railwayCnossos.evaluate(vehicleParameters4, trackParameters);
        RailWayParameters lWRailWay5 = railwayCnossos.evaluate(vehicleParameters5, trackParameters);

        for (int idFreq = 0; idFreq < 24; idFreq++) {

            //Day
            double rolling = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTDay1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTDay2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTDay3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTDay4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTDay5) / 10));
            double tractionA = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTDay1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTDay2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTDay3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTDay4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTDay5) / 10));
            double tractionB = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTDay1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTDay2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTDay3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTDay4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("TRACTIONB").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTDay5) / 10));
            assertEquals(expectedValuesLWRollingD[idFreq], rolling, EPSILON_TEST1);
            assertEquals(expectedValuesLW_Traction_A_D[idFreq], tractionA, EPSILON_TEST1);
            assertEquals(expectedValuesL_Traction_B_D[idFreq], tractionB, EPSILON_TEST1);

            //Evening
            rolling = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTEvening1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTEvening2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTEvening3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTEvening4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTEvening5) / 10));
            tractionA = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTEvening1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTEvening2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTEvening3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTEvening4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTEvening5) / 10));
            ...
            //Night
            rolling = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTNight1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTNight2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTNight3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTNight4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("ROLLING").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTNight5) / 10));
            tractionA = 10 * Math.log10(Math.pow(10, (lWRailWay1.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit1) + deltaTNight1) / 10) + Math.pow(10, (lWRailWay2.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit2) + deltaTNight2) / 10) + Math.pow(10, (lWRailWay3.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit3) + deltaTNight3) / 10) + Math.pow(10, (lWRailWay4.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit4) + deltaTNight4) / 10) + Math.pow(10, (lWRailWay5.getRailwaySourceList().get("TRACTIONA").getlW()[idFreq] + 10 * Math.log10(nBUnit5) + deltaTNight5) / 10));
