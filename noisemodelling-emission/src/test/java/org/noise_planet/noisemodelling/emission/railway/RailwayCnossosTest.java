...
public class RailwayCnossosTest {
    ...
    public void Test_Cnossos_Rail_emission_section_5() throws IOException {
        ...
        int nTracks = 2;
        String trackTransfer = "7";
        String railRoughness = "4";
        String impactNoise = "1";
        String bridgeTrasnfert = "0";
        int curvature = 0;
        boolean isTunnel = false;
    ...
    public void Test_Cnossos_Rail_emission_section_6() throws IOException {
        ...
        // Initiate Section Train
        int nTracks = 2;
        String trackTransfer = "SNCF5";
        String railRoughness = "SNCF1";
        String impactNoise = "";
    ...
    public void Test_Cnossos_Rail_emission_OC2() throws IOException {
        ...
        // Initiate Section Train
        int nTracks = 2;
        String trackTransfer = "SNCF7";
        String railRoughness = "SNCF2";
        String impactNoise = "SNCF1";
        int curvature = 0;
        double vMaxInfra = 160;
        double vehicleCommercial = 120;
        boolean isTunnel = false;
